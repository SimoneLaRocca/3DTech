...
<head>
    ...
    <script defer src="${contextPath}/js/suffixes.js"></script>
    <script defer src="${contextPath}/js/updateProduct.js"></script>
    <script defer src="${contextPath}/js/showModal.js"></script>
</head>
<body>
<%@ include file="admin-nav.jsp" %>
<input type="hidden" id="ctxPath" name="ctxPath" value="${contextPath}">
